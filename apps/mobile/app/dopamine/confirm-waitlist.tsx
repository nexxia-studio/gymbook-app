 ...
 *
 * Fichier volontairement sous `app/dopamine/` : l'AASA expose les paths `/dopamine/*`,
 * donc l'URL entrante est `/dopamine/confirm-waitlist` et expo-router mappe par path.
 *
 ...
 *  1. Confirmation auto : cette route N'appelle PAS `confirmWaitlist(booking)` du
 ...
 *  2. Retour post-login : après un login déclenché par ce lien, l'utilisateur n'est
