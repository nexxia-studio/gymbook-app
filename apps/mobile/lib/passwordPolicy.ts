...
// avec un message flou. (Jumeau de apps/dashboard/src/lib/passwordPolicy.ts.)
...
export function passwordRules(minLength = 8): PasswordRule[] {
  return [
    ...
    // Permissif : tout ce qui n'est ni lettre ni chiffre (jeu ouvert, pas de liste fermée).
