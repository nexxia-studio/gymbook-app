# Conditions générales de vente — Nouvelle Salle

**Dernière mise à jour : 2026-07-14** · Version 1.0

### 1. Identification et objet

Les présentes conditions régissent l'utilisation de l'application et l'achat de prestations auprès de **[à compléter par la salle]**, exploitant sous l'enseigne **Nouvelle Salle**, numéro d'entreprise **[à compléter par la salle]**, siège social **[à compléter par la salle]** (« la Salle »), vendeur des prestations. Lieu d'exploitation : [à compléter par la salle]. Contact : [à compléter par la salle].

L'application est éditée par **Nexxia.** — Antoine Monie, personne physique (indépendant) de droit belge, BCE **BE 1024.997.119**, Rue Grande Bruyère 6 B1, 4840 Welkenraedt, Belgique (« l'Éditeur »), prestataire technique et sous-traitant de la Salle. L'Éditeur ne vend rien aux membres. Les paiements sont traités par **Mollie B.V.** pour le compte de la Salle.
...
5.3. Le droit s'exerce par email à l'adresse de contact de la Salle ([à compléter par la salle]), ou via support@viniz.app qui transmettra à la Salle, le cas échéant au moyen du formulaire légal de rétractation.
...
Le traitement des données est décrit dans la Politique de confidentialité, accessible dans l'application (Profil → Confidentialité) et sur viniz.app/legal/privacy. Responsable du traitement : la Salle. Sous-traitant principal : Nexxia. (plateforme Viniz) ; autres sous-traitants : Supabase, Mollie, Resend, Expo/Apple.
