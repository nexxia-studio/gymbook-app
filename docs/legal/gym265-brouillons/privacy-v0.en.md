...
The application is provided to your gym by **Nexxia.** — Antoine Monie, a Belgian sole trader (natural person), company number **BE 1024.997.119**, Rue Grande Bruyère 6 B1, 4840 Welkenraedt, Belgium — publisher of the **Viniz** platform.
...
- **Who to contact for the platform**: support@viniz.app, for anything concerning the technical operation of the application, a security incident, or if your gym does not respond.
...
- **What Nexxia. does not do**: use your data for its own purposes, sell it, or use it for advertising.
...
**Publisher / processor**: Nexxia. (Antoine Monie) — Rue Grande Bruyère 6 B1, 4840 Welkenraedt, Belgium — company number BE 1024.997.119 — support@viniz.app
